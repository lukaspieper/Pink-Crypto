...
extern "C" JNIEXPORT jint JNICALL Java_de_lukaspieper_crypto_pink_argon2_Argon2id_nativeArgon2Hash(
        JNIEnv *env,
        jobject /* thiz */,
        jint mode,
        jint version,
    ...
    static jclass byteBufferTargetClazz = env->FindClass("de/lukaspieper/crypto/pink/argon2/ByteBufferTarget");
